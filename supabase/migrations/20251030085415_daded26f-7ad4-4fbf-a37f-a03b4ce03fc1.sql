-- Fix the get_user_credits_detailed function to properly read from user_usage table
...
BEGIN
    ...
    ELSE
        ...
        -- Use COALESCE to handle null case and directly get the count
        ...
        -- If no record found, free_credits_used will be 0 (from COALESCE default)
