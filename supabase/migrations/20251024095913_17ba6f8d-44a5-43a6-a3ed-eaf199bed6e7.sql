-- Fix get_user_credits_detailed function to properly track free credits
...
BEGIN
    ...
    ELSE
        ...
        SELECT * INTO user_usage_record
        FROM public.user_usage
        WHERE user_id = user_uuid
        AND current_period_number = current_period_value;
        
        IF user_usage_record IS NOT NULL THEN
            free_credits_used := user_usage_record.credits_used_current_period;
        ELSE
            free_credits_used := 0;
        END IF;
